...
__decorate([
    lib_1.autoload(Model),
    __metadata("design:type", Model)
], Repository.prototype, "model", void 0);
Repository = __decorate([
    lib_1.type('Repository'),
    __metadata("design:paramtypes", [Object])
], Repository);
exports.Repository = Repository;
let CustomMetadataRepository = class CustomMetadataRepository {
    constructor(metadata) {
...
CustomMetadataRepository = __decorate([
    lib_1.type('CustomMetadataRepository'),
    __metadata("design:paramtypes", [Object])
...
__decorate([
    lib_1.autoload(CustomMetadataRepository),
    __metadata("design:type", CustomMetadataRepository)
