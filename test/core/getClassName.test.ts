...
import { getClassName, type, setLogger } from '../../lib/'
import { logger } from '../../lib/core/getClassName'
...
describe('.getClassName()', function() {
  ...
  describe('Deprecated', function() {
    ...
    describe('class which has no .getClassName() and static className', function() {
      ...
      for (const falsyValue of falsyValues) {
        it(
          'does not display the warning message if process.env.OBFUSCABLE_WARNING is falsy = ' + falsyValue,
          function() {
