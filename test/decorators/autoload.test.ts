import 'jest'
import { register, autoload, type } from '../../lib'
...
export class TestAutoloadPropertyDecorator {
  ...
  @autoload(Repository) repository: Repository
  @autoload(CustomMetadataRepository) customMetadataRepository: CustomMetadataRepository
